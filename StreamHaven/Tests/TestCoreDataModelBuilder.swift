...
enum TestCoreDataModelBuilder {
    static let sharedModel: NSManagedObjectModel = {
        ...
        streamCache.properties = [
            makeStringAttribute("streamURL", isOptional: false), makeDateAttribute("cachedAt"), makeDateAttribute("lastAccessed"), makeDateAttribute("expiresAt"), makeStringAttribute("cacheIdentifier", isOptional: false)
        ]
        ...
        upNextQueueItem.properties = [
            makeStringAttribute("contentID", isOptional: false), makeStringAttribute("contentType", isOptional: false), makeDateAttribute("addedAt"), makeInt32Attribute("position"), makeBoolAttribute("autoAdded"), upNextQueueItemProfile
        ]

        watchlist.properties = [
            makeStringAttribute("name", isOptional: false), makeDateAttribute("createdAt"), makeDateAttribute("updatedAt"), makeStringAttribute("icon", isOptional: false), watchlistItems, watchlistProfile
        ]

        watchlistItem.properties = [
            makeStringAttribute("contentID", isOptional: false), makeStringAttribute("contentType", isOptional: false), makeDateAttribute("addedAt"), makeInt32Attribute("position"), watchlistItemWatchlist
        ]
        ...
        model.entities = [
            profile, favorite, watchHistory, movie, series, season, episode, channel, channelVariant, epgEntry, download, playlistSource, streamCache, playlistCache, upNextQueueItem, watchlist, watchlistItem, actor, credit
        ]
